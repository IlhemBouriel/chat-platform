...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{ URL::to('deconnect') }}"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                        </li>
                    </ul>
                    <!-- end dropdown-user -->
                </li>
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div><strong> {{ Session::get('name')}} </strong></div>
                    ...
                    <li class="selected">
                     ...
                     <li>
                        <a href="timeline.html"><i class="fa fa-flask fa-fw"></i>My publications</a>
                    </li>
                    <li>
                        <a href="tables.html"><i class="fa fa-table fa-fw"></i>Messaging</a>
                    </li>
                    <li>
                        <a href="forms.html"><i class="fa fa-edit fa-fw"></i>Find friends</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
    ...
    <script src="{{  URL::asset('assets/scripts/dashboard-demo.js') }}"></script>
